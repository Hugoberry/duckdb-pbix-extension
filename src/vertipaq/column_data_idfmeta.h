#ifndef COLUMN_DATA_IDFMETA_H_
#define COLUMN_DATA_IDFMETA_H_
...
class column_data_idfmeta_t : public kaitai::kstruct {
...
public:
    ...
    column_data_idfmeta_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, column_data_idfmeta_t* p__root = 0);
...
public:
    ~column_data_idfmeta_t();

    class c_p_element_t : public kaitai::kstruct {

    public:

        c_p_element_t(kaitai::kstream* p__io, column_data_idfmeta_t::block_t* p__parent = 0, column_data_idfmeta_t* p__root = 0);
    ...
    private:
        ...
        column_data_idfmeta_t* m__root;
        column_data_idfmeta_t::block_t* m__parent;
    ...
    public:
        ...
        column_data_idfmeta_t* _root() const { return m__root; }
        column_data_idfmeta_t::block_t* _parent() const { return m__parent; }
    };
    ...
    public:
        ...
        c_s1_element_t(kaitai::kstream* p__io, column_data_idfmeta_t::c_s0_element_t* p__parent = 0, column_data_idfmeta_t* p__root = 0);
    ...
    private:
        ...
        column_data_idfmeta_t* m__root;
        column_data_idfmeta_t::c_s0_element_t* m__parent;
    ...
    public:
        ...
        column_data_idfmeta_t* _root() const { return m__root; }
        column_data_idfmeta_t::c_s0_element_t* _parent() const { return m__parent; }
    };
    ...
    public:
        ...
        c_s0_element_t(kaitai::kstream* p__io, column_data_idfmeta_t::c_p_element_t* p__parent = 0, column_data_idfmeta_t* p__root = 0);
    ...
    private:
        ...
        std::string m_cs_tag_end;
        column_data_idfmeta_t* m__root;
        column_data_idfmeta_t::c_p_element_t* m__parent;
    ...
    public:
        ...
        std::string cs_tag_end() const { return m_cs_tag_end; }
        column_data_idfmeta_t* _root() const { return m__root; }
        column_data_idfmeta_t::c_p_element_t* _parent() const { return m__parent; }
    };
    ...
    public:
        ...
        s_d_os_element_t(kaitai::kstream* p__io, column_data_idfmeta_t::block_t* p__parent = 0, column_data_idfmeta_t* p__root = 0);
    ...
    public:
        ...
        s_s_element_t(kaitai::kstream* p__io, column_data_idfmeta_t::c_s0_element_t* p__parent = 0, column_data_idfmeta_t* p__root = 0);
    ...
    public:
        ...
        block_t(kaitai::kstream* p__io, column_data_idfmeta_t* p__parent = 0, column_data_idfmeta_t* p__root = 0);
    ...
    private:
        ...
        column_data_idfmeta_t* m__root;
        column_data_idfmeta_t* m__parent;

    public:
        c_p_element_t* cp() const { return m_cp; }
        s_d_os_element_t* sdos() const { return m_sdos; }
        column_data_idfmeta_t* _root() const { return m__root; }
        column_data_idfmeta_t* _parent() const { return m__parent; }
    };
    ...
    public:
        ...
        c_s_d_os1_element_t(kaitai::kstream* p__io, column_data_idfmeta_t::c_s_d_os_element_t* p__parent = 0, column_data_idfmeta_t* p__root = 0);
    ...
    private:
        ...
        column_data_idfmeta_t* m__root;
        column_data_idfmeta_t::c_s_d_os_element_t* m__parent;
    ...
    public:
        ...
        column_data_idfmeta_t* _root() const { return m__root; }
        column_data_idfmeta_t::c_s_d_os_element_t* _parent() const { return m__parent; }
    };
    ...
    public:
        ...
        c_s_d_os_element_t(kaitai::kstream* p__io, column_data_idfmeta_t::s_d_os_element_t* p__parent = 0, column_data_idfmeta_t* p__root = 0);
    ...
    private:
        ...
        std::string m_csdos_tag_end;
        column_data_idfmeta_t* m__root;
        column_data_idfmeta_t::s_d_os_element_t* m__parent;
    ...
    public:
        ...
        std::string csdos_tag_end() const { return m_csdos_tag_end; }
        column_data_idfmeta_t* _root() const { return m__root; }
        column_data_idfmeta_t::s_d_os_element_t* _parent() const { return m__parent; }
    };
